...
public double scoreMenu(String name){
    ...
    public double getTotalSemisterPoints(int year,int semister){
        if(year==1&&semister==1){
            ...
            return toAllPoints(courses21);
        }
        else if(year==2&&semister==2){
            return toAllPoints(courses22);
        }
        else if(year==3&&semister==1){
            return toAllPoints(courses31);
        }
        else if(year==3&&semister==2){
            return toAllPoints(courses32);
        }
        else if(year==4&&semister==1){
            return toAllPoints(courses41);
        }
        else if(year==4&&semister==2){
            return toAllPoints(courses42);
        }
        else if(year==5&&semister==1){
            return toAllPoints(courses51);
        }
        else if(year==5&&semister==2){
            return toAllPoints(courses52);
        }
        else{
            return 0;
        }
    ...
    public int getTotalSemisterCredits(int year,int semister){
        if(year==1&&semister==1){
            ...
            return toAllCredits(courses21);
        }
        else if(year==2&&semister==2){
            return toAllCredits(courses22);
        }
        else if(year==3&&semister==1){
            return toAllCredits(courses31);
        }
        else if(year==3&&semister==2){
            return toAllCredits(courses32);
        }
        else if(year==4&&semister==1){
            return toAllCredits(courses41);
        }
        else if(year==4&&semister==1){
            return toAllCredits(courses41);
        }
        else if(year==4&&semister==2){
            return toAllCredits(courses42);
        }
        else if(year==5&&semister==1){
            return toAllCredits(courses51);
        }
        else if(year==5&&semister==2){
            return toAllCredits(courses52);
        }
        else{
            return 0;
        }
    ...
    public double getTotalPoints(int year,int semister){
        if(year==1&&semister==1){
            ...
            return toAllPoints(courses11)+toAllPoints(courses12)+toAllPoints(courses21);
        }
        else if(year==2&&semister==2){
            return toAllPoints(courses11)+toAllPoints(courses12)+toAllPoints(courses21)
            +toAllPoints(courses22);
        }
        else if(year==3&&semister==1){
            return toAllPoints(courses11)+toAllPoints(courses12)+toAllPoints(courses21)
            +toAllPoints(courses22)+toAllPoints(courses31);
        }
        else if(year==3&&semister==2){
            return toAllPoints(courses11)+toAllPoints(courses12)+toAllPoints(courses21)
            +toAllPoints(courses22)+toAllPoints(courses31)+toAllPoints(courses32);
        }
        
        else if(year==4&&semister==1){
            return toAllPoints(courses11)+toAllPoints(courses12)+toAllPoints(courses21)
            +toAllPoints(courses22)+toAllPoints(courses31)+toAllPoints(courses32)+
            toAllPoints(courses41);
        }
        else if(year==4&&semister==2){
            return toAllPoints(courses11)+toAllPoints(courses12)+toAllPoints(courses21)
            +toAllPoints(courses22)+toAllPoints(courses31)+toAllPoints(courses32)+
            toAllPoints(courses41)+toAllPoints(courses42);
        }
        else if(year==5&&semister==1){
            return toAllPoints(courses11)+toAllPoints(courses12)+toAllPoints(courses21)
            +toAllPoints(courses22)+toAllPoints(courses31)+toAllPoints(courses32)+
            toAllPoints(courses41)+toAllPoints(courses42)+toAllPoints(courses51);
        }
        else if(year==5&&semister==2){
            return toAllPoints(courses11)+toAllPoints(courses12)+toAllPoints(courses21)
            +toAllPoints(courses22)+toAllPoints(courses31)+toAllPoints(courses32)+
            toAllPoints(courses41)+toAllPoints(courses42)+toAllPoints(courses51)+toAllPoints(courses52);
        }
        return 0;
    }
    public int getTotalCredits(int year,int semister){
        if(year==1&&semister==1){
            ...
            return toAllCredits(courses11)+toAllCredits(courses12)+toAllCredits(courses21);
        }
        else if(year==2&&semister==2){
            return toAllCredits(courses11)+toAllCredits(courses12)+toAllCredits(courses21)+toAllCredits(courses22);
        }
        else if(year==3&&semister==1){
            return toAllCredits(courses11)+toAllCredits(courses12)+toAllCredits(courses21)+toAllCredits(courses22)
            +toAllCredits(courses31);
        }
        else if(year==3&&semister==2){
            return toAllCredits(courses11)+toAllCredits(courses12)+toAllCredits(courses21)+toAllCredits(courses22)
            +toAllCredits(courses31)+toAllCredits(courses32);
        }
        else if(year==4&&semister==1){
            return toAllCredits(courses11)+toAllCredits(courses12)+toAllCredits(courses21)+toAllCredits(courses22)
            +toAllCredits(courses31)+toAllCredits(courses32)+toAllCredits(courses41);
        }
        else if(year==4&&semister==2){
            return toAllCredits(courses11)+toAllCredits(courses12)+toAllCredits(courses21)+toAllCredits(courses22)
            +toAllCredits(courses31)+toAllCredits(courses32)+toAllCredits(courses41)+toAllCredits(courses42);
        }
        else if(year==5&&semister==1){
            return toAllCredits(courses11)+toAllCredits(courses12)+toAllCredits(courses21)+toAllCredits(courses22)
            +toAllCredits(courses31)+toAllCredits(courses32)+toAllCredits(courses41)+toAllCredits(courses42)
            +toAllCredits(courses51);
        }
        else if(year==5&&semister==2){
            return toAllCredits(courses11)+toAllCredits(courses12)+toAllCredits(courses21)+toAllCredits(courses22)
            +toAllCredits(courses31)+toAllCredits(courses32)+toAllCredits(courses41)+toAllCredits(courses42)
            +toAllCredits(courses51)+toAllCredits(courses52);
        }
        return 0;
    }
